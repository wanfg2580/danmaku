...
public class Request {
    public static String login(String username, String roomId, String devId, String timestamp,
        ...
        return String.format(
            ...
            username, roomId, devId, timestamp, vk, ltkid, stk);
    }
    ...
    public static String buildMessage(String message) {
        ...
        return String.format(
            "type@=chatmessage/receiver@=0/content@=%s/scope@=/col@=0/pid@=/p2p@=0/nc@=0/rev@=0/ifs@=0/sid@=/lid@=0/",
            message);
    }
}
